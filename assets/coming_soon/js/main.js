...
(function($) {
	"use strict";
		...
		//Image Background 
		$(".image-background").backstretch("http://localhost/eadms/assets/coming_soon/images/image-bg.jpg");
		...
		//Particle Background 
		$(".particle-background").backstretch("http://localhost/eadms/assets/coming_soon/images/bg/particle-bg.jpg");
		...
		$(".snowdrops-background").backstretch("http://localhost/eadms/assets/coming_soon/images/bg/snowdrops-bg.jpg");
				
		//HTML5 Video Background 
		$(".video-background").backstretch("http://localhost/eadms/assets/coming_soon/video/Storm_darck.jpg");
